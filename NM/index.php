    ...
    <body class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <img src="img/910.jpg" class="embed-responsive-item"  width="304" height="236">
                </div>
                <div class="col-sm-4">
                    <img src="img/opiniao.png" class="embed-responsive-item"  width="304" height="236">
                </div>
                <div class="col-sm-4">
                    <img src="img/203.png" class="embed-responsive-item"  width="304" height="236">
                </div>
            </div>
        </div>
        <hr>
