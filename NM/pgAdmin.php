    ...
    for ($i = 0; $i < count($anunciantes); $i++):
        ?>
                                <tr class="info">
                                    ...
                                    <td><a data-toggle="modal" data-target="#myModal<?= $anunciantes[$i]['id'] ?>"><?php if ($anunciantes[$i]['ativo'] == 1) {
                            echo 'Ativo';
                        } else {
                            echo 'Inativo';
                        } ?></a>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="container-fluid">
                                                            <form action="#" method="post">
                                                                ...
                                                                <label class="radio-inline"><input type="radio" name="status" <?php if ($anunciantes[$i]['ativo'] == 1) {
                            echo ' selected ';
                        } ?> value="1">Ativar</label>
                                                                <label class="radio-inline"><input type="radio" name="status" <?php if ($anunciantes[$i]['ativo'] == 0) {
                            echo ' selected ';
